...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Placeholder values
    int totalParticipants = 0; // Total expected based on capacity
    int checkedIn = 0;
    int maxCapacity = 100;
    int remaining = maxCapacity - checkedIn;
    
    double crowdRatio = maxCapacity > 0 ? (checkedIn / maxCapacity) : 0;
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildStatCard('Capacity', maxCapacity.toString(), Colors.grey),
                ],
              ),
            ),
            Row(
